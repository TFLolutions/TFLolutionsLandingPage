    ...
    return (
      ...
      <footer className="bg-white dark:bg-gray-900 mt-10">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <a href="#" className="hover:underline">TecnoFix™</a>. All Rights Reserved.
              </span>
