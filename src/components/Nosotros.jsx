...
const Nosotros = () => {
  return (
    ...
    <div className="max-w-screen-2xl px-4 py-8 mx-auto">
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatevr cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them.</p>
        </div>
